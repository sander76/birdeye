...
def test_single_node_up_down(settings_no_git: Settings):
    ...
    tree_viewer._focussed_node.set_expanded(False)
...
def test_up_after_twice_into_list(settings_no_git: Settings):
    ...
    tv._focussed_node.set_expanded(True)
...
def test_expand_true_on_node(settings_no_git: Settings):
    # ..root
    # ├── pyproject.toml
    # ├── src
    # │   ├── main.py
    ...
    ft._focussed_node.set_expanded(True)
    assert ft._focussed_node.focussed is True


def test_expand_false_on_node(settings_no_git: Settings):
    # ..root
    # ├── pyproject.toml
    # ├── src
    # │   ├── main.py
    ...
    assert ft._focussed_node.set_expanded(False)
